...
SRCREV = "linux4sam_5.6-rc2"

KBRANCH = "linux-4.9-at91"
#SRC_URI = "git://github.com/linux4sam/linux-at91.git;protocol=git;branch=${KBRANCH}"

#SRC_URI = "git://nihilanth:/svr/git/SPDR2/4.9-spider2;protocol=git;branch=${KBRANCH}"
SRC_URI = "git://tom@nihilanth:/svr/git/SPDR2/4.9-spider2;protocol=ssh;branch=${KBRANCH}"
